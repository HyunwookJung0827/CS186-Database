        ...
        */
        ...
        private Record fetchNextRecord() {
            ...
            if (this.leftRecord == null) {
                ...
                // Set rightRecord to next one until it is equal to current leftRecord
                ...
                // Set leftRecord to the next one until it is equal to the new rightRecord if necessary
                while (compare(this.leftRecord, this.rightRecord) < 0) {
                    if (this.leftIterator.hasNext()) {
                        this.leftRecord = this.leftIterator.next();
                    }
            ...
            // If the records were not equal, reset iterators and fetch records again
            if (compare(this.leftRecord, this.rightRecord) != 0) {
                this.marked = false;
                if (!this.leftIterator.hasNext()) {
                ...
                return this.fetchNextRecord();
            } else {
                Record fetch = this.leftRecord.concat(this.rightRecord);
                if (!this.rightIterator.hasNext()) {
                    if (!this.leftIterator.hasNext()) {
                        this.leftRecord = null;
                    } else {
